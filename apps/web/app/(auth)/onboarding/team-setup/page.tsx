...
export default function TeamSetupPage() {
  ...
  const mutation = useMutation({
    mutationFn: async () => {
      const res = await api.team.workspaces.create({ name: workspaceName });
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 14, color: 'var(--color-text-muted)', margin: 0, lineHeight: 1.6 }}>
            Create a workspace where your team can collaborate on projects, assign tasks and share reminders.
          </p>
        </div>
